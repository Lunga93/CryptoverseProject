	...
	<div class="container">
		<div class="row">
          ...
          <fieldset>
                        ...
                        <input type="number" name="amount" id="amount" size="25" required><br>
                    ...
                    <label for="expiryDate"> Expiry Date:</label><br>
                        ...
                        <label for="CVCNumber"> CVC Number:</label><br>
                        <input type="number" name="CVCNumber" id="CVCNumber" size="25" maxlength="4" required><br>


                        <label for="bank"> Type of Bank:</label><br>
